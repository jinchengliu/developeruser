...
- (void)defalutInit
{
    ...
    self.layer.borderColor =[UIColor colorWithRed:140/255.0 green:117/255.0 blue:79/255.0 alpha:1].CGColor;
...
//                                                 alpha:1.0f];
    ...
    _titleView.textColor = [UIColor colorWithRed:198/255.0 green:173/255.0 blue:136/255.0 alpha:1];
    //[UIColor whiteColor];
...
- (void)setTitle:(NSString *)title
{
   // UIView * view=[[UIView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 40)];
    ...
    //[_listView setTableHeaderView:view];
}
