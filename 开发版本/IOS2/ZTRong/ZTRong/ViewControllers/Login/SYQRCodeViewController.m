...
- (void)initTitleView
{
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0,self.view.frame.size.height-44,kDeviceWidth, 44)];
...
- (void)createBackBtn
{
    ...
    CGPoint centerPoint=CGPointMake(self.view.frame.size.width/2, self.view.frame.size.height-22);
    //[btn setFrame:CGRectMake(0, 28, 60, 24)];
    btn.center=centerPoint;
    btn.bounds=CGRectMake(0, 0, self.view.frame.size.width, 44);
